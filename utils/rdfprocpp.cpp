...
int main(int argc, char * argv[])
{
  ...
  World world;
  CLuceneStorage::initialise(world);
...
*/
  ...
  const unsigned char* query_string = (const unsigned char*)"PREFIX fd: <http://freedesktop.org/standards/xesam/1.0/core#> PREFIX strigi: <http://strigi.sf.net/ontologies/0.9#> SELECT ?url, ?depth WHERE { ?x fd:fileExtension \"pdf\" . ?x fd:url ?url . ?x strigi:depth ?depth }";
